...
async def start_command(message: Message, bot: Bot):
    try:
        ...
        if args and args[0] == "guide":
            guide_text = """
            Привет! 💜
Рады видеть тебя в нашем чате. Чтобы тебе было проще освоиться, вот полезные ссылки:
...
А теперь заходи в общий чат, расскажи немного о себе (как зовут, что привело тебя к нам) и знакомься с участниками. Добро пожаловать! 🌟
    """
